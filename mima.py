                        ...
                        while True: 
                            if serialn_umber == 1:
                                ...
                                if serialn_umber1 == 1:
                                    ...
                                    db = pymysql.connect("localhost","root","bc123","webnews",charset='utf8')
                                    cursor = db.cursor()
                                    print("1 查询所有  2 搜索关键字查询  3 序号查询")
                                    a = int(input('请输入查询序号:'))
                                    if a == 1:
                                        czsy = 'SELECT * FROM yonghuguanli'
                                        try:
                                            cursor.execute(czsy)
                                    ...
                                    if a == 2:
                                        b = input('请输入你要查找的关键词:')
                                        c = '%' + b + '%'
                                        guanjianzi = "SELECT * FROM yonghuguanli WHERE name LIKE '%s'" % c
                                        try:
                                            cursor.execute(guanjianzi)
                                            neirong = cursor.fetchall()
                                            for row in neirong:
                                                yong_id = row[0]
                                                name = row[1]
                                ...
                                if serialn_umber2 == 1:
                                    ...
                                    if a == 2:
                                         b = input('请输入你要查找的关键词:')
                                         c = '%'+b+'%'
                                         guanjianzi = "SELECT * FROM news WHERE n_title LIKE '%s'"%c
                                         try:
                                             cursor.execute(guanjianzi)
                                             neirong = cursor.fetchall()
                                             for row in neirong:
                                    ...
                                    if a == 3:
                                        b = int(input('请输入查询序号:'))
                                        chakan = "SELECT * FROM news WHERE n_id=%d"%b
                                        try:
                                            cursor.execute(chakan)
                                            neirong = cursor.fetchall()
                                            for row in neirong:
